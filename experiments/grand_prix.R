grand_prix_plan <- function() {
  list(
    ...
    # Scenarios: true data-generating distributions.
    tar_target(
      sim_scenario,
      list(
    ...
    tar_target(
      sim_long,
      build_sim_long(universal_inference, infimum_martingale, ripr_sequence, batch_ripr)
    ),
